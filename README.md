...
- **Dark Patterns Detection** *(dissertation, June 2026)* — Building an AI-assisted pipeline to scrape and analyse Terms & Conditions and Privacy Policies from the UK's 50 most popular apps using the Claude API to detect manipulative language patterns
- **Supply Chain Intelligence** — Reporting on global supply chain and logistics markets as Intern Data Journalist at The Supply Chainer
...
- **Tools:** Claude API · web scraping · REST APIs · SQLite · Docker · OpenShift · Git
...
7 years B2B journalism across global publications:
- **The Supply Chainer** — Intern Data Journalist *(2026–present)*
- **IDG** (Computerworld, CIO.com, CSO) — Global technology markets
- **Dataquest India** — Senior Correspondent, data & technology
...
*Cardiff, UK — relocating to London*
